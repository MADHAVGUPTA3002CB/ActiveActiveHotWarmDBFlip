...
def _workload_payload(plan: BenchmarkPlan, case: BenchmarkCase) -> dict[str, Any]:
    return {
        ...
        "active_update_percent": plan.workload.active_update_percent,
        "retiring_update_percent": plan.workload.retiring_update_percent,
        "update_seed_rows_per_table": plan.workload.update_seed_rows_per_table,
